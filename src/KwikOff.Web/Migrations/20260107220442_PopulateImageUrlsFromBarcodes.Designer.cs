...
namespace KwikOff.Web.Migrations
{
    ...
    [Migration("20260107220442_PopulateImageUrlsFromBarcodes")]
    partial class PopulateImageUrlsFromBarcodes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KwikOff.Web.Domain.Entities.ComparisonResult", b =>
                {
                    ...
                    b.Property<string>("SecondarySearchMethod")
                        .HasColumnType("text")
                        .HasColumnName("secondary_search_method");

                    b.Property<bool>("UsedSecondarySearch")
                        .HasColumnType("boolean")
                        .HasColumnName("used_secondary_search");
